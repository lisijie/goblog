...
(function($) {
    ...
    $.fn.colorpicker = function(options) {
        ...
        function initColor(){
            ...
            +'<tr><td width="3"><td><input type="text" id="DisColor" size="6" disabled style="border:solid 1px #000000;background-color:#ffff00;width:60px; height:20px; padding:0; margin-top:5px"></td>'
            +'<td width="3"><td><input type="text" id="HexColor" size="7" style="width:60px; height:20px; padding:0; margin-top:5px; border:inset 1px;font-family:Arial; margin-right:10px" value="#000000"> <a href="javascript:void(0);" id="_cclose">关闭</a> | <a href="javascript:void(0);" id="_creset">清除</a></td></tr></table></td></table>'
